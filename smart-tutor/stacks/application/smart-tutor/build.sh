show_help() {
    ...
    printf "  %s\n" "--asp_version           ASP.NET Core version, default: 6.0"
    printf "  %s\n" "--sdk_version           .NET SDK version, default: 6.0"
    printf "  %s\n" "--src_url               Smart Tutor application source code URL, default: https://github.com/Clean-CaDET/tutor/archive/refs/heads/master.tar.gz"
