...
CREATE TABLE "KnowledgeComponents" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "Name" text NULL,
    "KnowledgeComponentId" integer NULL,
    CONSTRAINT "PK_KnowledgeComponents" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_KnowledgeComponents_KnowledgeComponents_KnowledgeComponentId" FOREIGN KEY ("KnowledgeComponentId") REFERENCES "KnowledgeComponents" ("Id") ON DELETE RESTRICT
);


CREATE TABLE "KnowledgeComponentsProgresses" (
    "Id" integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "Progress" double precision NOT NULL,
    "KnowledgeComponentId" integer NOT NULL,
    "LearnerId" integer NOT NULL,
    CONSTRAINT "PK_KnowledgeComponentsProgresses" PRIMARY KEY ("Id")
);
...
CREATE INDEX "IX_KnowledgeComponents_KnowledgeComponentId" ON "KnowledgeComponents" ("KnowledgeComponentId");
