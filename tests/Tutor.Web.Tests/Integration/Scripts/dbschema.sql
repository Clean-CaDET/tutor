...
CREATE TABLE "ArrangeTaskContainerSubmissions" (
    ...
    CONSTRAINT "FK_ArrangeTaskContainerSubmissions_Submissions_ArrangeTaskSubm~" FOREIGN KEY ("ArrangeTaskSubmissionId") REFERENCES "Submissions" ("Id") ON DELETE RESTRICT
);
