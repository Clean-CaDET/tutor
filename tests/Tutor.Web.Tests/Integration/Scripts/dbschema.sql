...
CREATE TABLE "MRQAnswers" (
    "Id" integer GENERATED BY DEFAULT AS IDENTITY,
    "MRQContainerId" integer NOT NULL,
    "Text" text NULL,
    "IsCorrect" boolean NOT NULL,
    "Feedback" text NULL,
    CONSTRAINT "PK_MRQAnswers" PRIMARY KEY ("Id"),
    CONSTRAINT "FK_MRQAnswers_MultiResponseQuestions_MRQContainerId" FOREIGN KEY ("MRQContainerId") REFERENCES "MultiResponseQuestions" ("Id") ON DELETE CASCADE
);
...
CREATE INDEX "IX_MRQAnswers_MRQContainerId" ON "MRQAnswers" ("MRQContainerId");
