...
namespace Tutor.Infrastructure.Migrations
{
    ...
    [Migration("20220217092650_migration0")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tutor.Core.DomainModel.AssessmentEvents.ShortAnswerQuestions.Saq", b =>
                {
                    b.HasBaseType("Tutor.Core.DomainModel.AssessmentEvents.AssessmentEvent");

                    b.Property<List<string>>("AcceptableAnswers")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Tutor.Core.DomainModel.AssessmentEvents.ShortAnswerQuestions.SaqSubmission", b =>
                {
                    b.HasBaseType("Tutor.Core.DomainModel.AssessmentEvents.Submission");
                    ...
                    b.HasDiscriminator().HasValue("SaqSubmission");
                });
            ...
            modelBuilder.Entity("Tutor.Core.DomainModel.AssessmentEvents.ShortAnswerQuestions.Saq", b =>
                {
                    b.HasOne("Tutor.Core.DomainModel.AssessmentEvents.AssessmentEvent", null)
                        .WithOne()
                        .HasForeignKey("Tutor.Core.DomainModel.AssessmentEvents.ShortAnswerQuestions.Saq", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
