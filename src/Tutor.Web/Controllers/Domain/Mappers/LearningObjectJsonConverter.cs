...
//     public class LearningObjectJsonConverter : JsonConverter<AssessmentEventDTO>
//     {
//         public override bool CanConvert(Type typeToConvert) =>
//             typeof(AssessmentEventDTO).IsAssignableFrom(typeToConvert);
//
//         public override AssessmentEventDTO Read(
...
//             }
//             else if (assessmentEvent is QuestionDTO question)
//             {
//                 WriteQuestion(writer, question);
//             }
//             else if (assessmentEvent is ArrangeTaskDTO task)
//             {
//                 WriteArrangeTask(writer, task);
//             }
//
//             writer.WriteNumber("id", assessmentEvent.Id);
//
