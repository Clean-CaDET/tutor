...
public interface ILearnerService : IStakeholderService<Learner>
{
    ...
    Result<(List<Learner> existingLearners, List<Learner> newLearners)> BulkRegister(List<Learner> learners, List<string> usernames, List<string> passwords, string learnerType);
}