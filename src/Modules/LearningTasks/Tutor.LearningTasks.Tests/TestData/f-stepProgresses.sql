INSERT INTO "learningTasks"."StepProgresses" (
	...
	VALUES (-1, 'SomeAnswer', 2, -4, -3, -1, null, '');
INSERT INTO "learningTasks"."StepProgresses" (
    "Id", "Answer", "Status", "StepId", "LearnerId", "TaskProgressId", "Evaluations", "Comment")
	VALUES (-2, null, 0, -7, -3, -2, null, '');
INSERT INTO "learningTasks"."StepProgresses" (
    "Id", "Answer", "Status", "StepId", "LearnerId", "TaskProgressId", "Evaluations", "Comment")
	VALUES (-3, null, 0, -8, -3, -3, null, '');
INSERT INTO "learningTasks"."StepProgresses" (
    "Id", "Answer", "Status", "StepId", "LearnerId", "TaskProgressId", "Evaluations", "Comment")
	VALUES (-4, 'SomeAnswer', 3, -9, -3, -4, '[{{"StandardId": -7, "Points": 5, "Comment": "Excellent"}}]', 'Good job!');
INSERT INTO "learningTasks"."StepProgresses" (
    "Id", "Answer", "Status", "StepId", "LearnerId", "TaskProgressId", "Evaluations", "Comment")
