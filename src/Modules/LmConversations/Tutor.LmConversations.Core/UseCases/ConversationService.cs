...
public class ConversationService : IConversationService
{
    ...
    private readonly ILmConversationsUnitOfWork _unitOfWork;

    public ConversationService(IMapper mapper, IConversationRepository conversationRepository, ITokenRepository tokenRepository, ILmHttpSender lmHttpSender, ILmConversationsUnitOfWork unitOfWork)
    {
        _mapper = mapper;
        _conversationRepository = conversationRepository;
        _tokenRepository = tokenRepository;
        _lmHttpSender = lmHttpSender;
