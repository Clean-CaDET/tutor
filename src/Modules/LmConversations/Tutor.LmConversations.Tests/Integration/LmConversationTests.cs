...
namespace Tutor.LmConversations.Tests.Integration;

public class LmConversationTests : BaseLmConversationsIntegrationTest
{
    public LmConversationTests(LmConversationsTestFactory factory) : base(factory) { }
    ...
    public async void Saves_new_conversation(string learnerId, MessageRequest messageRequest, MessageResponse expectedResponse)
    {
        ...
        var dbContext = scope.ServiceProvider.GetRequiredService<LmConversationsContext>();
    ...
    private static LmConversationsController CreateController(IServiceScope scope, string id)
    {
        return new LmConversationsController(scope.ServiceProvider.GetRequiredService<IConversationService>())
        {
