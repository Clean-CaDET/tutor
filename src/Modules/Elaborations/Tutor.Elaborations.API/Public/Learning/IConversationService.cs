...
public interface IConversationService
{
    ...
    IAsyncEnumerable<string> StartConversationAsync(int taskId, string content, int learnerId, CancellationToken ct);
    IAsyncEnumerable<string> SubmitTurnAsync(int attemptId, string content, int learnerId, CancellationToken ct);
